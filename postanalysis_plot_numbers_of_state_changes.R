...
data_long_states$treatment[data_long_states$condition == 'mCherry_aSynWT_DMSO'] <- 'control'
data_long_states$treatment[data_long_states$condition == 'mCherry_aSynWT_SynD'] <- 'SynD'
data_long_states$treatment[data_long_states$condition == 'mCherry_aSynA53T_DMSO'] <- 'control'
data_long_states$treatment[data_long_states$condition == 'mCherry_aSynA53T_SynD'] <- 'SynD'

data_long_states$condition[data_long_states$condition == 'mCherry_aSynWT_DMSO'] <- 'WT'
data_long_states$condition[data_long_states$condition == 'mCherry_aSynWT_SynD'] <- 'WT'
data_long_states$condition[data_long_states$condition == 'mCherry_aSynA53T_DMSO'] <- 'A53T'
data_long_states$condition[data_long_states$condition == 'mCherry_aSynA53T_SynD'] <- 'A53T'


# To order the conditions manually
data_long_states$condition <- factor(data_long_states$condition, levels=c("WT", "A53T"))
my_comparisons <- list( c("WT", "A53T"))
...
p_states_relevant
ggsave(p_states_relevant, filename ="state_changes_relevant.png", width = 6, height = 10)


# --------------------------------------------------
# Only "all_changes"

data_long_states_all_changes <- data_long_states[which(data_long_states$movement == "all_changes"),]

p_states_all_changes <- ggplot(data_long_states_all_changes,aes(x=condition,y=measurement))+
  facet_grid(movement~treatment, switch="x") +
  geom_boxplot(width=0.5, aes(fill=condition), alpha=0.2) + #,draw_quantiles = c(0.25, 0.5, 0.75)
  geom_jitter(width = 0.2, size = 0.5, aes(color=condition)) + #position = position_jitterdodge(seed = 1, dodge.width = 0.9)
  scale_color_manual(values = cbp) +
...
ggsave(p_states_all_changes, filename ="state_changes_all_changes.png", width = 6, height = 3)
...
# --------------------------------------------------
# State changes collected for individual trajectories
# --------------------------------------------------
...
# Read all files with selected name ending and extension
filenames <- Sys.glob(file.path("mCherry*/*_changes.csv"))

data_long_states <- merge_info_tables(filenames)

data_long_states <- gather(data_long_states, movement, measurement, RS:all_changes, factor_key=TRUE)
...
p_states_trajectories_relevant <- ggplot(data_long_states,aes(x=condition,y=measurement))+
  facet_grid(movement~treatment, switch="x") +
  geom_boxplot(width=0.5, aes(fill=condition), alpha=0.2) + #,draw_quantiles = c(0.25, 0.5, 0.75)
  geom_jitter(width = 0.2, size = 0.5, aes(color=condition)) + #position = position_jitterdodge(seed = 1, dodge.width = 0.9)
  scale_color_manual(values = cbp) +
...
p_states_trajectories_relevant
ggsave(p_states_trajectories_relevant, filename ="state_changes_trajectories_relevant.png", width = 6, height = 10)
...
p_states_trajectories_all_changes <- ggplot(data_long_states_all_changes,aes(x=condition,y=measurement))+
  facet_grid(movement~treatment, switch="x") +
  geom_boxplot(width=0.5, aes(fill=condition), alpha=0.2) + #,draw_quantiles = c(0.25, 0.5, 0.75)
  geom_jitter(width = 0.2, size = 0.5, aes(color=condition)) + #position = position_jitterdodge(seed = 1, dodge.width = 0.9)
  scale_color_manual(values = cbp) +
...
p_states_trajectories_all_changes
ggsave(p_states_trajectories_all_changes, filename ="state_changes_trajectories_all_changes.png", width = 6, height = 3)
...
#   scale_x_continuous(limits = c(-0.001,1), breaks = seq(0,1,by = 0.1))
# p_mov_wo_median
# svg("svg_plots_output_final/density_ratios_moving_time_to_all_time_wo_treatment_median.svg",  width=3.5, height=2.5)
# p_mov_wo_median
# dev.off()
# 
# 
...
#                               color = condition)) + #fill = condition, 
#   geom_violin(width=0.5, aes(color = condition)) + #position = "raincloud", 
...
# p_mov_overlap
# svg("svg_plots_output_final/density_ratios_moving_time_to_all_time_wo_treatment_overlap.svg",  width=4, height=1.5)
# p_mov_overlap
# dev.off()
# 
# #WITH TREATMENT
...
# # #stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
# # p_mov_with
# # svg("svg_plots_output_final/Density of ratios of time spent moving to all time with mean with treatment.svg",  width=5, height=7)
# # p_mov_with
# # dev.off()
# 
# 
...
# 
# p_mov_with_median
# svg("svg_plots_output_final/density_ratios_moving_time_to_all_time_with_treatment_median.svg",  width=3.5, height=6)
# p_mov_with_median
# dev.off()
# 
...
#   scale_x_continuous(limits = c(-0.001,1), breaks = seq(0,1,by = 0.2))
# p_mov_with_overlap
# svg("svg_plots_output_final/density_ratios_moving_time_to_all_time_with_treatment_overlap.svg",  width=4, height=3)
# p_mov_with_overlap
# dev.off()
# 
# 
...
# # #stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
# # p_mov_traj_wo
# # svg("svg_plots_output_final/density_ratios_trajectories_moving_time_to_all_time_wo_treatment_mean.svg",  width=3.5, height=2.5)
# # p_mov_traj_wo
# # dev.off()
# 
# #https://cran.r-project.org/web/packages/ggridges/vignettes/introduction.html
...
# svg("svg_plots_output_final/density_ratios_trajectories_moving_time_to_all_time_wo_treatment_median.svg",  width=3.5, height=2.5)
# p_mov_traj_wo_median
# dev.off()
# 
...
#   scale_x_continuous(limits = c(-0.001,1), breaks = seq(0,1,by = 0.2))
# p_mov_traj_overlap
# svg("svg_plots_output_final/density_ratios_trajectories_moving_time_to_all_time_wo_treatment_overlap.svg",  width=4, height=1.5)
# p_mov_traj_overlap
# dev.off()
# 
# 
...
# # #stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
# # p_mov_traj_with
# # svg("svg_plots_output_final/TRAJECTORIES Density of ratios of time spent moving to all time with mean with treatment.svg",  width=5, height=4)
# # p_mov_traj_with
# # dev.off()
# 
# 
...
# svg("svg_plots_output_final/density_ratios_trajectories_moving_time_to_all_time_with_treatment_median.svg",  width=3.5, height=6)
# p_mov_traj_with_median
# dev.off()
# 
...
# svg("svg_plots_output_final/density_ratios_trajectories_moving_time_to_all_time_with_treatment_overlap.svg",  width=4, height=3)
# p_mov_traj_with_overlap
# dev.off()
# 
# 
...
# #stat_compare_means(label = "p.signif", method = "t.test", ref.group = "Tau441")
# p_vel
# svg("svg_plots_output_final/data_long_velocities_wo_treatment_all_facetted.svg",  width=7, height=3)
# p_vel
# dev.off()
# 
# #PLOT MEAN PER CELL
...
#   stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
# p_vel_mean
# svg("svg_plots_output_final/data_long_velocities_wo_treatment_mean.svg",  width=2, height=3)
# p_vel_mean
# dev.off()
# 
# #PLOT MAX PER CELL
...
#   stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
# p_vel_max
# svg("svg_plots_output_final/data_long_velocities_wo_treatment_max.svg",  width=2, height=3)
# p_vel_max
# dev.off()
# 
# 
...
# ) 
# arrange_wo
# svg("svg_plots_output_final/data_long_velocities_wo_treatment_arrange_all.svg",  width=7, height=6)
# arrange_wo
# dev.off()
# 
# 
...
# #stat_compare_means(label = "p.signif", method = "t.test", ref.group = "Tau441")
# p_vel_treat
# svg("svg_plots_output_final/data_long_velocities_with_treatment_all_facetted.svg",  width=6, height=6)
# p_vel_treat
# dev.off()
# 
# 
# #PLOT MEAN PER CELL
# min(data_long_velocities_with_treatment_mean$measurement)
...
#   ggtitle("Mean velocity (d(smoothed_disp)/d(time)), \nA&R combined") +
#   stat_summary(fun = mean, geom = "point",colour = "black", size=1) +
#   scale_y_continuous(limits = c(0,0.3), breaks = seq(0,0.4,by = 0.05)) + #pretty(data_long_velocities_wo_treatment$measurement, n = 10)
#   stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
# p_vel_treat_mean
# svg("svg_plots_output_final/data_long_velocities_with_treatment_mean.svg",  width=5, height=3)
# p_vel_treat_mean
# dev.off()
# 
# #PLOT MAX PER CELL
...
#   ggtitle("Max velocity (d(smoothed_disp)/d(time)), \nA&R combined") +
#   stat_summary(fun = mean, geom = "point",colour = "black", size=1) +
#   scale_y_continuous(limits = c(0,0.6), breaks = seq(0,0.6,by = 0.05)) + #pretty(data_long_velocities_wo_treatment$measurement, n = 10)
#   stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
# p_vel_treat_max
# svg("svg_plots_output_final/data_long_velocities_with_treatment_max.svg",  width=5, height=3)
# p_vel_treat_max
# dev.off()
# 
# 
...
# ) 
# arrange_with
# svg("svg_plots_output_final/data_long_velocities_with_treatment_arrange_all.svg",  width=6, height=6)
# arrange_with
# dev.off()
# 
# 
...
# ) 
# arrange_all
# svg("svg_plots_output_final/data_long_velocities_arrange_all.svg",  width=10, height=12)
# arrange_all
# dev.off()
# 
# 
...
# #p_fun_wo
# # svg("svg_plots_output_final/data_long_funplots_wo_treatment.svg",  width=20, height=10)
# # p_fun_wo
# # dev.off()
# 
# # Density plot
...
#   ggtitle("Percent of respective motion points")
# p_percent_counts
# svg("svg_plots_output_final/data_percent_counts_wo_treatment.svg",  width=4, height=4)
# p_percent_counts
# dev.off()
# 
# #WITH TREATMENT
...
#   scale_x_continuous(breaks = seq(-20, 20, by = 1)) #limits = c(-5, 5), breaks = seq(-5, 5, by = 1)
# #p_fun_with
# # svg("svg_plots_output_final/data_long_funplots_with_treatment.svg",  width=12, height=5)
# # p_fun_with
# # dev.off()
# 
# 
