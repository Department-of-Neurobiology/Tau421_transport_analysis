...
p_states_wo_all
svg("svg_plots_output_final/state_changes_wo_treatment_all.svg",  width=7, height=3)
p_states_wo_all
dev.off()
...
p_states_wo_state_changes <- ggplot(data_long_states_wo_treatment,aes(x=condition,y=measurement))+
  ...
  scale_y_continuous(limits = c(0,3.6), breaks = seq(0,3.5,by = 0.5)) +
  stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
p_states_wo_state_changes
svg("svg_plots_output_final/state_changes_wo_treatment_state_changes.svg",  width=2, height=3)
p_states_wo_state_changes
dev.off()

write.table(data_long_states_wo_treatment, "svg_plots_output_final/state_changes_wo_treatment_state_changes.csv")
...
p_states_with_all
svg("svg_plots_output_final/state_changes_with_treatment_all.svg",  width=5, height=9)
p_states_with_all
dev.off()
...
svg("svg_plots_output_final/state_changes_with_treatment_state_changes.svg",  width=6, height=3)
p_states_with_state_changes
dev.off()

write.table(data_long_states_with_treatment, "svg_plots_output_final/state_changes_with_treatment_state_changes.csv")
...
svg("svg_plots_output_final/state_changes_trajectories_wo_treatment_all.svg",  width=7, height=3)
p_states_traj_wo_all
dev.off()
...
p_states_wo_state_changes <- ggplot(data_long_states_trajectories_wo_treatment,aes(x=condition,y=measurement))+
  ...
  stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
p_states_wo_state_changes
svg("svg_plots_output_final/state_changes_trajectories_wo_treatment_state_changes.svg",  width=2, height=3)
p_states_wo_state_changes
dev.off()
...
svg("svg_plots_output_final/state_changes_trajectories_with_treatment_all.svg",  width=5, height=9)
p_states_traj_with_all
dev.off()
...
p_states_with_state_changes <- ggplot(data_long_states_trajectories_with_treatment,aes(x=condition,y=measurement))+
  ...
  stat_compare_means(method = "t.test", comparisons = my_comparisons, size = 3) #label = "p.signif", 
p_states_with_state_changes
svg("svg_plots_output_final/state_changes_trajectories_with_treatment_state_changes.svg",  width=6, height=3)
p_states_with_state_changes
dev.off()
